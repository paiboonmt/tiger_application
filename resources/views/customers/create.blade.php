                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="m_card" value="1234567890">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label>หมายเลขบัตรประจำตัว</label>
                                                <input type="text" class="form-control" name="p_visa" value="1234567890">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control bg-danger text-white" name="em_phone" value="1234567890" required>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label>ชื่อผู้ติดต่อฉุกเฉิน</label>
                                        <input type="text" class="form-control bg-danger text-white" name="em_name" value="นายสมชาย ใจดี" required>  
                                    </div>  
                                </div>  
                            </div>
                            <div class="row">
