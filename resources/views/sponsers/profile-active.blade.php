                        ...
                        <div class="row">
                            <div class="col-2 text-center">
                                <div class="position-relative">
                                    ...
                                    <a href="http://172.16.0.3/fighterimg/img/{{ $member->image }}"
                                ...
                                <div style="width: 350px;" class="px-2">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            <a href="http://172.16.0.3/fighterimg/file/{{ $doc->image }}"
                                                data-fancybox="gallery-2">
                                                <img src="http://172.16.0.3/fighterimg/file/{{ $doc->image }}"
                                                    width="100%" />
                                            </a>
                                        </div>
                                    </div>
