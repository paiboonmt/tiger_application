        ...
        <div class="col p-2">
            <div class="card">
                <div class="card-header bg-dark">
                    <h3 class="card-title">รายชื่อสปอนเซอร์</h3>
                </div>
                <div class="card-body">
                            ...
                            @foreach ($data as $c)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('sponsers.profile', $c->id) }}" class="badge badge-info"
                                            target="_blank">ดูโปรไฟล์</a>
                                    </td>
                                    <td>{{ $c->m_card }}</td>
                                    <td>{{ $c->fname }}</td>
                                    <td>{{ $c->nationalty }}</td>
                                    ...
                                    <td><span
                                            class="badge badge-success">{{ date('d-m-y', is_numeric($c->sta_date) ? $c->sta_date : strtotime($c->sta_date)) }}</span>
                                    </td>
                                    <td><span
                                            class="badge badge-warning">{{ date('d-m-y', is_numeric($c->exp_date) ? $c->exp_date : strtotime($c->exp_date)) }}</span>
                                    </td>
